class DressesController < ApplicationController
  ...
  # GET /dresses.json
  def index
    @dresses = Dress.paginate(page: params[:page], per_page: 6).order('sort ASC')
  end

  # GET /dresses/1
  # GET /dresses/1.json
  def show
    @others = Dress.paginate(page: params[:page], per_page: 4).order('sort ASC')
  end
  ...
  private
    ...
    def dress_params
      params.require(:dress).permit(:description, :cost, :category, :color)
    end
end
